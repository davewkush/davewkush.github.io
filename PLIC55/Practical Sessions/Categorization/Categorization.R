...
install.packages("RCurl") # for downloading our files from the web
library(RCurl)
library(tidyverse)
library(ggplot2)

# get your data file from my website
dataURL = "http://www.davewkush.github.io/PLIC55/Practical Sessions/Categorization/Categorization.R"
...
# you'll have to put in the filename of our data file (including path)
# I might have something like categ("/Downloads/categorization.csv")
